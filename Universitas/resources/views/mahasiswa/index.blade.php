            ...
            <div class="card-body">
                        ...
                        <tbody>
                            @foreach ($mahasiswa as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->npm }}</td>
                                    <td>{{ $item->nama }}</td>
                                    <td>{{ DateTime::createFromFormat('Y-m-d', $item->tanggal_lahir)->format('l, d F Y') }}
                                    </td>
                                    <td>{{ $item->kota_lahir }}</td>
                                    <td>{{ $item->Prodi->nama_prodi }}</td>
                                    <td>{{ $item->created_at }}</td>
                                    <td> <a href="{{ route('mahasiswa.edit', $item->id) }}"><i
                ...
                <div class="d-flex justify-content-end mt-3">
                    ...
                    @if (count($mahasiswa) != 0)
                        <button class="btn btn-danger btn-rounded ms-3" id="multi-delete"
                            data-route="{{ route('mhs-multi-delete') }}">Delete All Selected</button>
                    @endif
