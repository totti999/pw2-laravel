      ...
      <nav class="navbar col-lg-12 col-12 px-0 py-0 py-lg-4 d-flex flex-row">
        <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
          ...
          <div class="navbar-brand-wrapper">
            <a class="navbar-brand brand-logo" href=" {{ url('fakultas') }}"><img src="{{ asset('images/logo.svg')}}" alt="logo"/></a>
            <a class="navbar-brand brand-logo-mini" href=" {{ url('fakultas') }}"><img src="{{ asset('images/logo-mini.svg')}}" alt="logo"/></a>
          </div>
          <h4 class="font-weight-bold mb-0 d-none d-md-block mt-1">@yield('title')</h4>
          @php
              use Carbon\Carbon;
              
             $time = Carbon::now()->setTimeZone('Asia/Bangkok')->format('D, d M Y | h : i A');
          @endphp
          <ul class="navbar-nav navbar-nav-right">
            <li class="nav-item">
              <h4 class="mb-0 font-weight-bold d-none d-xl-block">{{$time}} </h4>
            </li>
